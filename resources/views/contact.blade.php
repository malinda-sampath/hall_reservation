                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <p class="mb-4">If you need assistance with lecture hall reservations or have any questions, please fill out the contact form below. We will get back to you as soon as possible.</p>
                            <form action="{{ url('contact_mail') }}" method="post">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="message" id="message" style="height: 150px;" placeholder="Message"></textarea>
